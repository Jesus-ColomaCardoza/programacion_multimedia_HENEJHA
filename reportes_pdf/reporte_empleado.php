    ...
    <?php 
     ...
     ?>
                            <div class="col-md-8">
                                ...
                                <h2 align="center" ><u>Registro de Empleados</u></h2> 
                                <table border="solid" >
                                    <thead class="table-success table-striped" >
                                        <tr>
                                            ...
                                            <th bgcolor="#2E64FE" style="color:white; margin: 0px;">ID_cargo</th>
                                            <th bgcolor="#2E64FE" style="color:white; margin: 0px;">ID_salario</th>
                                    ...
                                    <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php  echo $row['IDcargo_1']?></td>
                                                    <td><?php  echo $row['IDsalario_1']?></td>
